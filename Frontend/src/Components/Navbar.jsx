...
function Navbar() {
    ...
    <>
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
            ...
            <div className="navbar-start">
                ...
                <a className="text-xl font-bold cursor-pointer"><span className='text-pink-500'>B</span>ooK<span className='text-green-500'>s</span>tor<span className='text-red-500'>E</span></a>
            </div>
  ...
  {/* moon icon */}
  <svg
    className="swap-on h-7 w-7 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24 " onClick={()=>setTheme(theme === "dark"?"light":"dark")}>
